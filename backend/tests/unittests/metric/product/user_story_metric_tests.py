...
class UserStoriesNotReviewedTest(unittest.TestCase):
    ...
    def test_value(self):
        ...
        self.__birt.nr_user_stories.return_value = 25, ['aa', 'bb']
        self.__birt.reviewed_user_stories.return_value = 23, ['aa']
        self.assertEqual(2, self.__metric.value())
        self.assertEqual(['bb'], self.__metric.extra_info_rows())
...
class UserStoriesNotApprovedTest(unittest.TestCase):
    ...
    def test_value(self):
        ...
        self.__birt.approved_user_stories.return_value = 20, ['aa']
        self.__birt.reviewed_user_stories.return_value = 23, ['aa', 'bb']
...
class UserStoriesWithEnoughLTCsTest(unittest.TestCase):
    ...
    def test_value(self):
        """ Test that the value of the metric is the number of user stories that has too few logical test cases
            as reported by Birt. """
        self.__birt.nr_user_stories.return_value = 25, ['aa', 'bb']
        self.__birt.nr_user_stories_with_sufficient_ltcs.return_value = 23, ['aa']
